Library = (loadstring(game:HttpGet("https://pastefy.app/UoxavYaN/raw")))()
Window = Library:CreateWindow({
	["Title"] = "Var Hub";
	["Subtitle"] = "- Blox Fruit",
	["Image"] = "rbxassetid://6409799523"
})
wait(1)
Library:Notify({
	["Title"] = "Ui Library",
...
local Library =loadstring(game:HttpGet'https://pastefy.app/xcjYLsLD/raw')()
